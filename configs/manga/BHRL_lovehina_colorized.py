...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'voc_annotation/lovehina_vol01.json',
        img_prefix=data_root+ img_path,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'voc_annotation/lovehina_vol14.json',
        img_prefix=data_root+ img_path,
...
log_level = 'INFO'
work_dir = 'work_dirs/manga/BHRL_lovehina_trained_gaussian_fpn_min_2'
